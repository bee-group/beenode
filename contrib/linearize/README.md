# Linearize
Construct a linear, no-fork, best version of the Beenode blockchain. The scripts
run using Python 3 but are compatible with Python 2.

## Step 0: Install beenode_hash

https://github.com/bee-group/beenode_hash
...
JSON-RPC server. Running `beenoded` or `beenode-qt -server` will be sufficient.
...
* `input`: beenoded blocks/ directory containing blkNNNNN.dat
