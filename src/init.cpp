...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-masternodeblsprivkey=<n>", _("Set the masternode private key"));
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    if(fMasternodeMode) {
        ...
        if(!strmasternodeblsprivkey.empty()) {
            ...
            if(!CMessageSigner::GetKeysFromSecret(strmasternodeblsprivkey, activeMasternodeInfo.legacyKeyOperator, pubKeyMasternode))
    ...
    // ********************************************************* Step 11c: schedule Beenode-specific tasks
