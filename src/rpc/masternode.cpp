...
void masternode_list_help()
{
    throw std::runtime_error(
            ...
            "  owneraddress   - Print the masternode owner Beenode address\n"
            "  payee          - Print the masternode payout Beenode address (can be additionally filtered,\n"
            "                   partial match)\n"
            ...
            "  votingaddress  - Print the masternode voting Beenode address\n"
        );
}
...
void masternode_genkey_help()
{
    throw std::runtime_error(
            ...
            "Generate new masternodeblsprivkey\n"
            "\nArguments:\n"
...
[[ noreturn ]] void masternode_help()
{
    throw std::runtime_error(
        ...
        "  genkey       - Generate new masternodeblsprivkey, optional param: 'compressed' (boolean, optional, default=false) generate compressed privkey\n"
#ifdef ENABLE_WALLET
...
{ //  category              name                      actor (function)         okSafe argNames
  //  --------------------- ------------------------  -----------------------  ------ ----------
    { "beenode",               "masternode",             &masternode,             true,  {} },
    { "beenode",               "masternodelist",         &masternodelist,         true,  {} },
    { "beenode",               "masternodebroadcast",    &masternodebroadcast,    true,  {} },
    { "beenode",               "getpoolinfo",            &getpoolinfo,            true,  {} },
    { "beenode",               "sentinelping",           &sentinelping,           true,  {} },
#ifdef ENABLE_WALLET
    { "beenode",               "privatesend",            &privatesend,            false, {} },
#endif // ENABLE_WALLET
};
