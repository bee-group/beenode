    ...
    if (!streamConfig.good()) {
        ...
        if (configFile != nullptr) {
            std::string strHeader = "# Masternode config file\n"
                          "# Format: alias IP:port masternodeblsprivkey collateral_output_txid collateral_output_index\n"
                          "# Example: mn1 127.0.0.2:14244 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
