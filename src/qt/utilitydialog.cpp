    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Beenode Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Beenode Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  beenode-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Beenode in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BEENODE, 0.1 BEENODE, 1 BEENODE and 10 BEENODE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://beenodepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://beenodepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Beenode Core is shutting down...") + "<br /><br />" +
