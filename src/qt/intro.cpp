    ...
    signalled(false)
{
    ...
    ui->sizeWarningLabel->setText(
        tr("%1 will download and store a copy of the Beenode block chain.").arg(tr(PACKAGE_NAME)) + " " +
...
bool Intro::pickDataDirectory()
{
     ...
     * override -datadir in the beenode.conf file in the default data directory
     * (to be consistent with beenoded behavior)
     */
