    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Beenode Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Beenode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and beenode: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Beenode Core"), this);
    aboutAction->setStatusTip(tr("Show information about Beenode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Beenode Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Beenode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Beenode addresses"));
    ...
    openAction->setStatusTip(tr("Open a beenode: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Beenode Core help message to get a list with possible Beenode Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Beenode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Beenode network", "", count));
}
...
{
    QString strTitle = tr("Beenode Core"); // default title
