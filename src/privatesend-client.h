...
public:
    ...
    CPendingDsaRequest(const CService& addr_, const CSpysendAccept& dsa_):
        addr(addr_),
        dsa(dsa_),
    ...
    CSpysendAccept GetDSA() { return dsa; }
...
private:
    ...
    void RelayIn(const CSpySendEntry& entry, CConnman& connman);
