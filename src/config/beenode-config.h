/* src/config/beenode-config.h.  Generated from beenode-config.h.in by configure.  */
/* src/config/beenode-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BEENODE_CONFIG_H

#define BEENODE_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Beenode Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Beenode Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bee-group/beenode/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Beenode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Beenode Core 0.7.3"
