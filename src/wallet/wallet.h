...
public:
    ...
    bool SelectCoinsSpy(CAmount nValueMin, CAmount nValueMax, std::vector<CTxIn>& vecTxInRet, CAmount& nValueRet, int nPrivateSendRoundsMin, int nPrivateSendRoundsMax) const;
    ...
    /// Get 1000BEENODE output and keys which can be used for the Masternode
