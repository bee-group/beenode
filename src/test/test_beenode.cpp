...
#define BOOST_TEST_MODULE Beenode Test Suite

#include "test_beenode.h"
...
TestingSetup::TestingSetup(const std::string& chainName) : BasicTestingSetup(chainName)
{
    const CChainParams& chainparams = Params();
        ...
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_beenode_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
