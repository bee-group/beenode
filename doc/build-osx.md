...
NOTE: Building with Qt4 is still supported, however, could result in a broken UI. As such, building with Qt5 is recommended. Qt5 5.7 requires C++11 which Beenode Core doesn't fully support yet, Qt5 5.6.2 has some other issues, so make sure to install Qt version < 5.6.2 (5.6.1-1 is recommended).
...
1. Clone the GitHub tree to get the source code and go into the directory.
        ...
        git clone https://github.com/beenodecoin/beenode.git
        cd beenode
