...
If you generated a new masternode private key, you will need to update the remote `beenode.conf` files.

Shut down the daemon and then edit the file.

```nano .beenodecore/beenode.conf```

### Edit the masternodeprivkey
If you generated a new masternode private key, you will need to update the `masternodeprivkey` value in your remote `beenode.conf` file.
...
and comparing with the official explorer at https://explorer.beenode.org/chain/Beenode
...
Search your Masternodes on https://beenodeninja.pl/masternodes.html
