...
Spycoin Core 0.11.1 supports a full implementation of InstantX, Spysend improvements
and a new version of enforcement compatible with the newer Bitcoin architechure.
Latest release in 0.11.1.x tree is v0.11.1.26, which is rebranding Spycoin to Beenode.
...
- "Last Spysend message" text added in overview page
