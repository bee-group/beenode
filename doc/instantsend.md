...
This mechanism has been integrated into Bitcore-Node-Beenode which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/beenodepay/insight-api-beenode#web-socket-api](https://github.com/beenodepay/insight-api-beenode#web-socket-api)
* API: [https://github.com/beenodepay/insight-api-beenode#instantsend-transactions](https://github.com/beenodepay/insight-api-beenode#instantsend-transactions)
...
By default, the Beenode Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Beenode Core daemon:
