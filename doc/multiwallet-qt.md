...
Only requiring some minor changes is beenode.cpp.
...
Changes to beenode.cpp
----------------------
beenode.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
